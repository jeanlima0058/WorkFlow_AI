(function() {
  ...
  loginForm.addEventListener('submit', async (e) => {
      ...
      // ALTERAÇÃO: Removido o ícone de ampulheta, mantendo apenas o texto
      ...
      try {
          ...
          sessionStorage.setItem('access_token', loginData.access_token); // Mudança para sessionStorage

          const userData = await apiFetch('/auth/me');
          sessionStorage.setItem('user_data', JSON.stringify(userData)); // Mudança para sessionStorage

          window.location.href = '/dashboard.html'; // Navegação absoluta
      } catch (error) {
